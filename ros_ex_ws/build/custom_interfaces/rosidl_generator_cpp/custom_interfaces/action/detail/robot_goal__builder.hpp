...
public:
  ...
  : msg_(msg)
  {}
  ::custom_interfaces::action::RobotGoal_Feedback current_theta(::custom_interfaces::action::RobotGoal_Feedback::_current_theta_type arg)
  {
...
{
public:
  explicit Init_RobotGoal_Feedback_current_x(::custom_interfaces::action::RobotGoal_Feedback & msg)
  : msg_(msg)
  {}
...
class Init_RobotGoal_Feedback_distance
{
public:
  Init_RobotGoal_Feedback_distance()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RobotGoal_Feedback_current_x distance(::custom_interfaces::action::RobotGoal_Feedback::_distance_type arg)
  {
    msg_.distance = std::move(arg);
    return Init_RobotGoal_Feedback_current_x(msg_);
  }
...
{
  return custom_interfaces::action::builder::Init_RobotGoal_Feedback_distance();
}
